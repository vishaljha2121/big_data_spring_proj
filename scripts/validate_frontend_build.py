...
REQUIRED_FILES = [
    ...
    "src/shell/TopHeader.jsx",
    "src/shell/FeatureScopeBanner.jsx",
    ...
    "src/pages/MatchBrowserPage.jsx",
    "src/pages/ReplayCenterPage.jsx",
    "src/pages/PointTimelinePage.jsx",
    "src/pages/ReplayManifestPage.jsx",
    "src/pages/PredictionCenterPage.jsx",
    "src/pages/ModelPerformancePage.jsx",
    "src/pages/DataExplorerPage.jsx",
    "src/pages/ValidationPage.jsx",
    "src/pages/PipelineMonitorPage.jsx",
    "src/pages/ReportsPage.jsx",
    "src/pages/PlayersPage.jsx",
    "src/pages/PlayerComparisonPage.jsx",
    "src/pages/TournamentsPage.jsx",
    "src/pages/SurfaceAnalyticsPage.jsx",
    "src/pages/RankingsPage.jsx",
    "src/pages/pageUtils.jsx",
    "src/pages/MatchDetailPage.jsx",
    "src/utils/derivedMetrics.js",
